        ...
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-slate-400">Manage team members, skills, and workload</p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {filteredUsers.map(user => {
                    ...
                    return (
                        <div
                            key={user.id}
                            className="bg-slate-800 p-6 rounded-xl border border-slate-700 hover:border-blue-500/50 transition-all"
                        >
                            {/* Header */}
                            <div className="flex items-start gap-4 mb-4">
                                <div className="relative">
                                    ...
                                    />
                                    <div
                                        className={`absolute bottom-0 right-0 w-4 h-4 ${availabilityColors[user.availability || 'offline']} rounded-full border-2 border-slate-800`}
                                    />
                                </div>
                            ...
                            <div className="grid grid-cols-2 gap-3 pt-4 border-t border-slate-700">
                                <div>
                                    <div className="text-xl font-bold text-white">{activeTasks}</div>

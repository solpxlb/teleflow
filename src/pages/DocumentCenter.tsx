        ...
        <div className="space-y-6">
            ...
            <div className="flex justify-between items-center">
                <div>
                    ...
                    <p className="text-slate-600">Manage project documents and AutoCAD files</p>
                </div>
                ...
                <div className="bg-white p-4 rounded-xl border border-slate-200">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div className="text-xs text-slate-600">AutoCAD Files</div>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white p-4 rounded-xl border border-slate-200">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <div className="text-xs text-slate-600">Compliance Docs</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                {filteredDocuments.map(doc => {
                    ...
                    return (
                        <div
                            key={doc.id}
                            className="bg-white rounded-xl border border-slate-200 overflow-hidden hover:border-blue-500/50 transition-all group"
                        >
                            {/* Preview */}
                                ...
                                {doc.tags && doc.tags.length > 0 && (
                                    <div className="flex gap-1 mt-2 flex-wrap">
                                        {doc.tags.slice(0, 2).map(tag => (
                                            <span key={tag} className="text-xs bg-slate-700 text-slate-600 px-2 py-0.5 rounded">
                                                {tag}
                                            </span>
                                        ))}
                                    </div>
            ...
            {filteredDocuments.length === 0 && (
                <div className="text-center py-12 bg-slate-50 border border-slate-200 rounded-xl">
                    ...
                    <p className="text-slate-600 text-sm">No documents found</p>

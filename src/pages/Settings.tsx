    ...
    return (
        <div className="space-y-6">
            ...
            <div>
                ...
                <p className="text-slate-400">Manage your application preferences and configuration</p>
            </div>
                        ...
                        {activeTab === 'general' && (
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <select className="w-full bg-slate-900 border border-slate-700 rounded-lg px-4 py-2 text-slate-200 focus:outline-none focus:border-blue-500">
                        ...
                        {activeTab === 'notifications' && (
                            <div className="space-y-6">
                                ...
                                <div className="space-y-4">
                                    <label className="flex items-center justify-between p-4 bg-slate-900 rounded-lg">
                                        <div>
                                            <div className="font-medium text-white">Email Notifications</div>
                                            <div className="text-sm text-slate-400">Receive email updates for important events</div>
                                        </div>
                                        <input type="checkbox" defaultChecked className="w-5 h-5 rounded border-slate-600 bg-slate-800 text-blue-600" />
                                    </label>

                                    <label className="flex items-center justify-between p-4 bg-slate-900 rounded-lg">
                                        <div>
                                            <div className="font-medium text-white">Task Assignments</div>
                                            <div className="text-sm text-slate-400">Notify when tasks are assigned to you</div>
                                        </div>
                                        <input type="checkbox" defaultChecked className="w-5 h-5 rounded border-slate-600 bg-slate-800 text-blue-600" />
                                    </label>
                                    ...
                                    <label className="flex items-center justify-between p-4 bg-slate-900 rounded-lg">
                                        <div>
                                            <div className="font-medium text-white">Site Alerts</div>
                                            <div className="text-sm text-slate-400">Critical site status changes</div>
                                        </div>
                                        <input type="checkbox" defaultChecked className="w-5 h-5 rounded border-slate-600 bg-slate-800 text-blue-600" />
                                    </label>
                                    ...
                                    <label className="flex items-center justify-between p-4 bg-slate-900 rounded-lg">
                                        <div>
                                            <div className="font-medium text-white">Workflow Updates</div>
                                            <div className="text-sm text-slate-400">Workflow execution status updates</div>
                                        </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <div className="grid grid-cols-3 gap-3">
                                        <button className="p-4 bg-slate-900 border-2 border-blue-500 rounded-lg">
                                            <div className="w-full h-20 bg-gradient-to-br from-slate-900 to-slate-800 rounded mb-2"></div>
                                            <div className="text-sm text-white">Dark (Active)</div>
                                        </button>
                                        <button className="p-4 bg-slate-900 border-2 border-slate-700 rounded-lg opacity-50">
                                            <div className="w-full h-20 bg-gradient-to-br from-white to-slate-100 rounded mb-2"></div>
                                            <div className="text-sm text-slate-400">Light (Coming Soon)</div>
                                        </button>
                                        <button className="p-4 bg-slate-900 border-2 border-slate-700 rounded-lg opacity-50">
                                            <div className="w-full h-20 bg-gradient-to-br from-slate-800 to-blue-900 rounded mb-2"></div>
                                            <div className="text-sm text-slate-400">Auto (Coming Soon)</div>
                                        </button>
                                    </div>
                                </div>
                                ...
                                <div className="space-y-3">
                                    <div className="p-4 bg-slate-900 rounded-lg flex items-center justify-between">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div className="font-medium text-white">AutoCAD Cloud</div>
                                                <div className="text-sm text-slate-400">Sync AutoCAD files automatically</div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="p-4 bg-slate-900 rounded-lg flex items-center justify-between">
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div>
                                                <div className="font-medium text-white">Webhook API</div>
                                                <div className="text-sm text-slate-400">External system integrations</div>
                                            </div>
                                        </div>
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full bg-slate-900 border border-slate-700 rounded-lg px-4 py-2 text-slate-200 focus:outline-none focus:border-blue-500 mb-3"
                                    />
                                    <input
                                        type="password"

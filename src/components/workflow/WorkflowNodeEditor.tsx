...
const WorkflowNodeEditor: React.FC<WorkflowNodeEditorProps> = ({ node, onClose, onSave }) => {
                ...
                return (
                    <>
                        ...
                        <div>
                            ...
                            <textarea
                                className="w-full bg-white border border-slate-200 rounded-lg px-3 py-2 text-slate-700 focus:outline-none focus:border-blue-500 resize-none"
                                rows={3}
                            ...
                            <div className="space-y-2">
                                {['PDF', 'Image', 'AutoCAD', 'Excel', 'Word'].map(type => (
                                    <label key={type} className="flex items-center gap-2 text-sm text-slate-600">
                                        <input
                                            type="checkbox"
                                            className="rounded border-slate-600 bg-white text-blue-600 focus:ring-blue-500"
    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50">
            <div className="bg-slate-50 border border-slate-200 rounded-xl w-full max-w-md max-h-[80vh] overflow-hidden flex flex-col">
                {/* Header */}
                ...
                <div className="p-4 border-t border-slate-200 flex justify-end gap-2">
                    <button
                        onClick={onClose}
                        className="px-4 py-2 bg-white hover:bg-slate-100 text-slate-600 rounded-lg transition-colors"
                    >
                        Cancel
                    </button>
                    <button
